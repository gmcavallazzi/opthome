    ...
    <Card className="settings-card">
      ...
      <CardContent>
        ...
        <div className="settings-section">
          ...
          <div className="discharge-strategy">
            <label className="setting-label">Battery Discharge Strategy</label>
            <div className="strategies">
              <label className={`strategy-option ${batteryStrategy === 'peak_price' ? 'selected-strategy' : ''}`}>
                <input 
                  type="radio" 
                  name="batteryStrategy" 
                  className="strategy-radio" 
                  checked={batteryStrategy === 'peak_price'}
                  onChange={() => setBatteryStrategy('peak_price')}
                />
                <div className="strategy-content">
                  <span className="strategy-name">Peak Price Optimization</span>
                  <p className="strategy-description">Only discharge during peak price periods</p>
                </div>
              </label>

              <label className={`strategy-option ${batteryStrategy === 'evening_focus' ? 'selected-strategy' : ''}`}>
                <input 
                  type="radio" 
                  name="batteryStrategy" 
                  className="strategy-radio"
                  checked={batteryStrategy === 'evening_focus'}
                  onChange={() => setBatteryStrategy('evening_focus')}
                />
                <div className="strategy-content">
                  <span className="strategy-name">Evening Focus</span>
                  <p className="strategy-description">Prioritize evening hours (18:00-23:00)</p>
                </div>
              </label>

              <label className={`strategy-option ${batteryStrategy === 'low_solar' ? 'selected-strategy' : ''}`}>
                <input 
                  type="radio" 
                  name="batteryStrategy" 
                  className="strategy-radio"
                  checked={batteryStrategy === 'low_solar'}
                  onChange={() => setBatteryStrategy('low_solar')}
                />
                <div className="strategy-content">
                  <span className="strategy-name">Low Solar Backup</span>
                  <p className="strategy-description">Use when solar production is insufficient</p>
                </div>
              </label>

              <label className={`strategy-option ${batteryStrategy === 'ai_optimized' ? 'selected-strategy' : ''}`}>
                <input 
                  type="radio" 
                  name="batteryStrategy" 
                  className="strategy-radio"
                  checked={batteryStrategy === 'ai_optimized'}
                  onChange={() => setBatteryStrategy('ai_optimized')}
                />
                <div className="strategy-content">
                  <span className="strategy-name">AI Optimized</span>
                  <p className="strategy-description">Algorithm dynamically determines best strategy</p>
                </div>
              </label>
            </div>
          </div>
